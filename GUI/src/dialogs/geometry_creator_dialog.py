...
class GeometryCreatorDialog(QDialog):
    ...
    def _build_help_tab(self):
        ...
        help_text.setHtml(
            ...
            "<li><b>Gaussian Random Field</b> - Statistically homogeneous porous medium generated by "
            ...
            "<li><b>Dark pixels</b> (below threshold) = Pore (fluid)</li>"
            "<li><b>Light pixels</b> (above threshold) = Solid</li>"
            "<li>Threshold default = 128 (adjustable 0-255)</li>"
