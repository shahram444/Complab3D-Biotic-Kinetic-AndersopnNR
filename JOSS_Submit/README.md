...
13. [Two Ways to Get the Solver](#13-two-ways-to-get-the-solver)
...
17. [Running the Solver](#17-running-the-solver)
...
21. [Editing Kinetics and Recompiling](#21-editing-kinetics-and-recompiling)
22. [HPC Troubleshooting](#22-hpc-troubleshooting)

**[PART 3 — GUI Workflow Guide (CompLaB Studio)](#part-3--gui-workflow-guide-complab-studio)**

23. [GUI Prerequisites & Installation](#23-prerequisites)
24. [Launching the GUI](#24-launching-the-gui)
25. [Interface Overview](#25-interface-overview)
26. [Step-by-Step Workflow](#26-step-by-step-workflow)
27. [Panel Reference](#27-panel-reference)
28. [Kinetics Editor](#28-kinetics-editor)
29. [Running a Simulation from the GUI](#29-running-a-simulation-from-the-gui)
30. [Post-Processing](#30-post-processing)
31. [Project Files and XML Export](#31-project-files-and-xml-export)
32. [Preferences](#32-preferences)
33. [GUI Test Suite](#33-gui-test-suite)
34. [GUI Troubleshooting](#34-gui-troubleshooting)
...
│   └── output/                                  # Solver writes VTK/checkpoint files here
│
├── tests/                                       # C++ unit tests + analytical validation
│   ├── README.md
│   ├── cpp/                                     # 382 GoogleTest unit tests
...
│
├── docs/
│   ├── CompLaB3D_User_Tutorial.md
│   ├── CompLaB3D_Technical_Guide.md
│   └── Geometry_Generator_Tutorial.md
│
├── paper/                                       # JOSS manuscript
├── tools/geometry_generator.py
├── defineKinetics.hh
...
### Solver (C++ — required to build and run simulations)
...
| `test_eq_solver` / `_extended`                                                       | Anderson-NR equilibrium solver, stiff systems, log K ranges   | 51      |
...
### 5.2 Python / GUI Tests — 362+ tests (no solver required)
...
| `test_pipeline_e2e.py`      | End-to-end: template → XML → kinetics → fake solver run | 87    |
...
Five complete validation cases in `test_cases/abiotic/` verify solver correctness against closed-form analytical solutions.
...
**Dry-run check (no solver needed):**
...
| Document                    | Location                              |
| --------------------------- | ------------------------------------- |
| User Tutorial               | `docs/CompLaB3D_User_Tutorial.md`     |
| Technical Guide             | `docs/CompLaB3D_Technical_Guide.md`   |
| Geometry Generator Tutorial | `docs/Geometry_Generator_Tutorial.md` |
...
### Verify the GUI tests (~12 seconds, no solver required)
...
For **biotic** simulations, edit `defineKinetics.hh` to define your Monod rate expressions. For **abiotic** simulations, edit `defineAbioticKinetics.hh`. These headers are compiled into the solver — **you must rebuild after every edit** (see §21).
...
## 23. Analytical Validation Cases
...
## 32. Project Files and XML Export
...
| Kinetics changes not reflected       | `.hh` files modified but solver not recompiled | Recompile solver after every kinetics edit (see §28)                                                  |
