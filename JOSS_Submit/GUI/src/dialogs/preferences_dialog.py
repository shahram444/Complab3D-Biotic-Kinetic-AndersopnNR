...
class PreferencesDialog(QDialog):
    ...
    def _setup_ui(self):
        ...
        # MatchFixedString is case-insensitive by default in Qt6, so "dark"
        # correctly finds the "Dark" combo item without an extra flag.
    ...
    def apply_theme(theme_name):
        ...
        if not app:
            return
        styles_dir = Path(__file__).parent.parent.parent / "gui" / "styles"
