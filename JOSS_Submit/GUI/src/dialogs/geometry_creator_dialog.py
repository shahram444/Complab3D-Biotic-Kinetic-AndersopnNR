...
class GeometryCreatorDialog(QDialog):
    ...
    def __init__(self, project=None, config=None, parent=None, project_dir: str = ""):
        ...
        self._config = config
        self._worker = None
        # If a project directory is known, default output there so the generated
        # geometry.dat lands in <project_dir>/input/ automatically.
        self._default_output = project_dir if project_dir else "geometry_output"
        self._setup_ui()
    ...
    def _setup_ui(self):
        ...
        self._output_edit = QLineEdit(self._default_output)
        self._output_edit.setToolTip(
            "Output directory — geometry.dat will be saved to folder/input/.\n"
            "When a project is open this defaults to the project folder so\n"
            "the file lands in <project>/input/geometry.dat automatically.\n\n"
