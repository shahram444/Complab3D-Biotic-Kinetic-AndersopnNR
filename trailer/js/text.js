...
const TextRenderer = (() => {
  ...
  const FONTS = {
    ...
    earth_title: { size: 48, family: 'Courier New, monospace', color: '#ffffff', shadow: '#000000', align: 'center', baseline: 0.16, glow: true, glowColor: '#2acfaf', glowSize: 25 },
    earth_env: { size: 38, family: 'Courier New, monospace', color: '#2acfaf', shadow: '#000000', align: 'center', baseline: 0.78, glow: true, glowColor: '#2acfaf', glowSize: 18 },
