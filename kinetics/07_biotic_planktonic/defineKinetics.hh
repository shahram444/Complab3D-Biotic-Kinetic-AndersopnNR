/* ============================================================================
 * defineKinetics.hh - Scenario 07: Single Planktonic Bacteria (LBM Solver)
 * CompLaB3D - University of Georgia
 *
 * Single microbial species freely suspended in pore fluid as planktonic
 * bacteria. Biomass is transported by advection-diffusion using an LBM
 * lattice. The bacteria consume dissolved organic carbon (DOC) via
 * Monod kinetics.
 *
 * SPECIES MAPPING:
 *   B[0] = Planktonic heterotroph biomass [kg/m3]
